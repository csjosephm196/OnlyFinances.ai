    ...
    <div className="max-w-5xl mx-auto space-y-8 animate-in slide-in-from-bottom-4 duration-500">
      ...
      {processingResult && (
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm rounded-xl overflow-hidden"
        >
          <div className="px-6 py-4 border-b-2 border-indigo-100 dark:border-indigo-900/50 flex justify-between items-center bg-gradient-to-r from-slate-50 to-indigo-50/30 dark:from-slate-900 dark:to-indigo-950/30">
